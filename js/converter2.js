...
DataConverter.prototype.create = function(w,h) {
  ...
  var outputHeaderText = '<div class="groupHeader" id="inputHeader"><p class="groupHeadline">Output as JSON:<select name="Data Types" id="dataSelector">';
  ...
  this.outputTextArea = $('<textarea class="textInputs" id="dataOutput" style="width: 100%; height: 200px;"></textarea>');
