...
DataConverter.prototype.create = function(w,h) {
  ...
  this.inputTextArea = $('<textarea class="textInputs" id="dataInput" style="width: 750px; border: 1px solid #000;"></textarea>');
  ...
  this.outputTextArea = $('<textarea class="textInputs" id="dataOutput" style="width: 750px; border: 1px solid #000;"></textarea>');
